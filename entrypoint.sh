...
if [[ -z "${Vless_Path}" ]]; then
  Vless_Path="/71f7bda5-5bf6-4e04-8c9b-f820abd6bdf2-vless"
fi
echo ${Vless_Path}

if [[ -z "${Vless_UUID}" ]]; then
  Vless_UUID="71f7bda5-5bf6-4e04-8c9b-f820abd6bdf2"
fi
echo ${Vless_UUID}

if [[ -z "${Vmess_Path}" ]]; then
  Vmess_Path="/8f4d4709-e41d-4954-8213-6dfce57e72b3-vmess"
fi
echo ${Vmess_Path}

if [[ -z "${Vmess_UUID}" ]]; then
  Vmess_UUID="71f7bda5-5bf6-4e04-8c9b-f820abd6bdf2"
fi
echo ${Vmess_UUID}
